...
describe('Transaction', () => {
    ...
    describe('outputMap', () => {
        ...
        it('outputs the amounts to the recipients', ()=>{
    ...
    describe('update', () => {
        ...
        describe('and the amount is ivalid', () => {
        ...
        describe('and the amount is valid', () => {
            ...
            it('mantains total output that matches the input amount', () => {
                expect(
    ...
    describe('rewardTransaction()', () => {
        ...
        it('cretaes ones transaction for the minner with the `MINING_REWARD`', () => {
